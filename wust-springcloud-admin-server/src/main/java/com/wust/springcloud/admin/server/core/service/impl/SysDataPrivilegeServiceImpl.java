...
public class SysDataPrivilegeServiceImpl extends BaseServiceImpl implements SysDataPrivilegeService {
    ...
    @Override
    public void init(List<SysDataPrivilege> sysDataPrivilegeList) {
        DefaultBusinessContext ctx = DefaultBusinessContext.getContext();


        sysDataPrivilegeMapper.deleteAll();
        sysDataPrivilegeMapper.insertList(sysDataPrivilegeList);
         ...
         */
        for (SysDataPrivilege sysDataPrivilege : sysDataPrivilegeList) {
