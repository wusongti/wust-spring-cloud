...
public class MyImportExportController {
    ...
    public @ResponseBody
    BaseDto listPage(@RequestBody SysImportExportSearch sysImportExportSearch){
    ...
    public @ResponseBody MessageMap downloadFile(HttpServletRequest request, HttpServletResponse response){
        MessageMap mm = new MessageMap();
