...
import com.wust.springcloud.admin.server.xml.factory.XMLLookupFactory;
...
public class SysLookupServiceImpl extends BaseServiceImpl implements SysLookupService {
    @Autowired
    ...
    public ResponseDto init() {
        ...
        sysLookupMapper.insertList(sysLookups);
