...
import com.wust.springcloud.admin.server.dao.SysDataPrivilegeMapper;
import com.wust.springcloud.admin.server.dao.SysDataPrivilegeRulesMapper;
    ...
    public void init() {
        ...
        try {
            ...
            if (obj != null) {
                ...
                sysDataPrivilegeMapper.batchInsert(sysDataPrivileges);
                ...
                if (CollectionUtils.isNotEmpty(sysDataPrivilegeRulesCreates)) {
                    sysDataPrivilegeRulesMapper.batchInsert(sysDataPrivilegeRulesCreates);
                }
