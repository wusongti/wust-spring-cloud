...
import com.wust.springcloud.admin.server.dao.SysDataSourceMapper;
import com.wust.springcloud.admin.server.dao.SysUserMapper;
...
public class SysDataSourceServiceImpl implements SysDataSourceService {
    ...
    @Override
    public List<SysDataSourceList> listPage(SysDataSourceSearch search) {
        return sysDataSourceMapper.listPage(search);
    }

    @Override
    public List<SysDataSourceList> findByCondition(SysDataSourceSearch search) {
        return sysDataSourceMapper.findByCondition(search);
    }
    ...
    public MessageMap insert(SysDataSource entity) {
        ...
        try {
            ...
            entities.add(entity);
            sysDataSourceMapper.batchInsert(entities);
    ...
    @Override
    public int update(SysDataSource entity) {
        List<SysDataSource> entities = new ArrayList<>(1);
        entities.add(entity);
        return sysDataSourceMapper.batchUpdate(entities);
    }
